...
<div class="box1">
	<a href = "detail1.html"><button class ="bt1">등    급</button></a>
	<a href = "detail2.html"><button class ="bt2">등급 범위</button></a>
	<a href = "detail3.html"><button class ="bt3">할인 혜택</button></a>
			
			<div class = "rank-box">
							<table   class = "rank-box-box">
						<tr>
							<td class = "td-mini"> </td>
							<td>할인율</td>
						</tr>
						<tr>
							<td class = "td-mini"> 1</td>
							<td> % 할인</td>
						</tr>
						<tr>
							<td class = "td-mini"> 2</td>
							<td>  % 할인</td>
						</tr>
						<tr>
							<td class = "td-mini">3</td>
							<td> % 할인</td>
						</tr>
						<tr>
							<td class = "td-mini"> 4</td>
							<td>  % 할인</td>
						</tr>
						<tr>
							<td class = "td-mini">5</td>
							<td>  % 할인</td>
						</tr>
					</table>		
		   ...
		   <div>
		   <button class="de-select">  <!-- 우측하단 버튼 -->
				확   인
			</button>
		   </div>
</div>	   
